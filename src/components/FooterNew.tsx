        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-4">
              <span className="font-playfair text-4xl font-bold text-gold tracking-wider">
                MC
              </span>
            </Link>
            <h3 className="font-inter text-xs tracking-[0.25em] text-gold/80 uppercase mb-6">
              MICHAEL CHANDLER
            </h3>
          ...
          {/* Column 2 - Studio */}
          <div>
            <h4 className="font-inter text-xs tracking-[0.25em] text-white/40 uppercase mb-8">
              Studio
            </h4>
